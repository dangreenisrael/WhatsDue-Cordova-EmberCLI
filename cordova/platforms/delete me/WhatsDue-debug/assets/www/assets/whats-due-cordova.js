...
define('whats-due-cordova/tests/controllers/reminders.jshint', function () {
  ...
  test('controllers/reminders.js should pass jshint', function() { 
    ok(false, 'controllers/reminders.js should pass jshint.\ncontrollers/reminders.js: line 22, col 57, Missing semicolon.\ncontrollers/reminders.js: line 3, col 1, \'CustomUI\' is defined but never used.\n\n2 errors'); 
  });
...
if (runningTests) {
  ...
  require("whats-due-cordova/app")["default"].create({"name":"whats-due-cordova","version":"0.0.1.2f125df2"});
}
